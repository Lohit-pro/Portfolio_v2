          ...
          <section className="w-full md:w-1/2 flex justify-center">
            ...
            >
              <div className="flex flex-col md:flex-row md:justify-between w-full">
                ...
                />
                <input
                  className={`my-4 md:w-[40%] hover:md:w-[43%] dark:bg-[#252525] bg-[#fee4fe] focus:md:w-[43%] p-2 pl-3 border-[3px] hover:shadow-2xl shadow-secondary rounded-3xl outline-none border-dark dark:border-light focus:dark:border-light focus:border-dark bg-transparent hover:dark:border-light hover:border-dark hover:cursor-pointer transition-all duration-300 ${delay3 ? delay3 : "invisible"}`}
                  type="email"
                  placeholder="Email"
                  name="user_email"
                  value={userEmail}
              ...
              <input
                className={`w-full my-4 p-2 pl-3 border-[3px] dark:bg-[#252525] bg-[#fee4fe] hover:shadow-2xl shadow-secondary rounded-3xl outline-none border-dark dark:border-light focus:dark:border-light focus:border-dark bg-transparent hover:dark:border-light hover:border-dark hover:cursor-pointer transition-all duration-300 ${delay4 ? delay4 : "invisible"}`}
                type="text"
                placeholder="Subject"
                name="subject"
                value={subject}
              ...
              />
              <textarea
                className={`w-full my-4 p-2 pl-3 pb-20 md:pb-28 dark:bg-[#252525] bg-[#fee4fe] border-[3px] hover:shadow-2xl shadow-secondary rounded-3xl outline-none border-dark dark:border-light focus:dark:border-light focus:border-dark bg-transparent hover:dark:border-light hover:border-dark hover:cursor-pointer transition-all duration-300 ${delay5 ? delay5 : "invisible"}`}
