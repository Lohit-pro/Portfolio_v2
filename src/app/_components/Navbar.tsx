...
const Navbar: React.FC<NavbarProps> = ({ navText }) => {
  ...
  return (
    <div className="w-full fixed top-0 left-0 z-50 bg-light dark:bg-dark shadow-sm transition-colors duration-300">
      <div className="w-full my-2 md:my-6 md:mt-8 flex justify-between md:justify-around items-center px-4">
